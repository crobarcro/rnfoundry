...
tests={@rnfoundry.em.test.test_design_candidate_decode, ...
       ...
       @rnfoundry.em.test.test_radial_slotted_repair_characterization, ...
       @rnfoundry.em.test.test_radial_slotted_repair_order, ...
       @rnfoundry.em.test.test_design_space_simoptions, ...
       @rnfoundry.em.test.test_winding_configuration_parity, ...
