...
x=[baseChrom();0.25]; c=space.decode(x); assert(c.Data.MagnetSkew==0.25);
rnfoundry.em.test.assertNear(c.Data.tm,0.005,1e-15);
rnfoundry.em.test.assertNear(c.Data.ls,2,1e-15);
end
