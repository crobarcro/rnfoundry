function geom = radialslotgeometrylegacy(thetacoil, thetashoegap, ryoke, rcoil, ...
                                    rshoebase, rshoegap, roffset, side, varargin)
%RADIALSLOTGEOMETRYLEGACY Authoritative solver-free radial slot drawing geometry.
